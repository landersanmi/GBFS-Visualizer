...
from services import gbfs_free_bike_status_service, gbfs_station_information_service, gbfs_station_status_service, gbfs_system_information_service, gbfs_system_service
...
def post_gbfs(gbfs_system_id, gbfs_system):  # noqa: E501
    ...
    if connexion.request.is_json:
        gbfs_system = GbfsSystem.from_dict(connexion.request.get_json())  # noqa: E501
...
def post_station_information(gbfs_system_id, gbfs_station_information):  # noqa: E501
    ...
    """
    if connexion.request.is_json:
        gbfs_station_information = GbfsStationInformation.from_dict(connexion.request.get_json())  # noqa: E501
...
def post_system_information(gbfs_system_id, gbfs_system_information):  # noqa: E501
    ...
    """
    if connexion.request.is_json:
        gbfs_system_information = GbfsSystemInformation.from_dict(connexion.request.get_json())  # noqa: E501
